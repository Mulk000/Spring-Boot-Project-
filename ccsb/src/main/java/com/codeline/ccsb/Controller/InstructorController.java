...
public class InstructorController {
    ...
    @PostMapping("/create")
    public InstructorCreateResponse createInstructor(@RequestBody InstructorCreateRequest requestedObj)throws Exception{
        InstructorCreateRequest.validCreatesInstructorRequestObject(requestedObj);
        return instructorServices.saveInstructor(requestedObj);
